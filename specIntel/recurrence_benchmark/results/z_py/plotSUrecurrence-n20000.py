...
direc="../"
params=["n20000-c1", "n20000-c5", "n20000-c10", "n20000-c15"]
titles = ["\\textbf{Recurrence N=20000, C=1}",
          "\\textbf{Recurrence N=20000, C=5}",
          "\\textbf{Recurrence N=20000, C=10}",
          "\\textbf{Recurrence N=20000, C=15}",]
...
plt.savefig("../z_figs/SUrecurrenceP8-n20000.pdf", format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig("../z_figs/SUrecurrenceP8-n20000.png", format='png',bbox_extra_artists=(lgd,), bbox_inches='tight')
