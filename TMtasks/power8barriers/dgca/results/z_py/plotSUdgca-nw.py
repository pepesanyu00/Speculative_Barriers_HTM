...
direc="../"
params=["n2000-w2", "n8000-w2", "n2000-w8", "n8000-w8"]
titles = ["\\textbf{DGCA N=2000, A=2, T=4000}",
          "\\textbf{DGCA N=8000, A=2, T=4000}",
          "\\textbf{DGCA N=2000, A=8, T=4000}",
          "\\textbf{DGCA N=8000, A=8, T=4000}",]
# [synchronization method, label, file]
files = [["UNP", "Unprotected", "dgca_%s-%s-r-t%d-*"],
         ["PAR", "Parallel", "dgca_%s-%s-r-t%d-*"],
         ["TM", "TM", "dgca_%s-%s-r-t%d-*"],
         ["SB", "SB", "dgca_%s-%s-r-t%d-*"],
         ["CS", "CS", "dgca_%s-%s-r-t%d-*"]]
...
plt.savefig("../z_figs/SUdgcaP8-nw.pdf", format='pdf', bbox_inches='tight')
plt.savefig("../z_figs/SUdgcaP8-nw.png", format='png', bbox_inches='tight')
