...
files = [["UNP", "UNP", "histo_%s-%d-5-%d-large_img.bin-*"],
         ["PAR", "PAR", "histo_%s-%d-5-%d-large_img.bin-*"],
         ["TM", "TM", "histo_%s-%d-5-%d-large_img.bin-*"],
         ["SB", "SB", "histo_%s-%d-5-%d-large_img.bin-*"],
         ["CS", "CS", "histo_%s-%d-5-%d-large_img.bin-*"],]
...
plt.savefig("./SUhistoChunk5P8.pdf", format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig("./SUhistoChunk5P8.png", format='png',bbox_extra_artists=(lgd,), bbox_inches='tight')
