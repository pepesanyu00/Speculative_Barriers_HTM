...
direc="../results/"
params=["1000-1", "1000-5"]
titles = ["\\textbf{Histogram I=1000 C=1}",
          "\\textbf{Histogram I=1000 C=5}",]
# [synchronization method, label, file]
files = [["UNP", "UNP", "histo_%s-%s-%d-large_img.bin-*"],
         ["PAR", "PAR", "histo_%s-%s-%d-large_img.bin-*"],
         ["TM", "TM", "histo_%s-%s-%d-large_img.bin-*"],
         ["SB", "SB", "histo_%s-%s-%d-large_img.bin-*"],
         ["CS", "CS", "histo_%s-%s-%d-large_img.bin-*"],]
...
plt.savefig("./SUhistoP8.pdf", format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig("./SUhistoP8.png", format='png',bbox_extra_artists=(lgd,), bbox_inches='tight')
