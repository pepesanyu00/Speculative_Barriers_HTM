...
for i in range(len(params)):
  ...
  if i == 0: #Si es el último imprimo la leyenda
    lgd=ax.legend(frameon=False, fontsize=lfs, ncol=2, bbox_to_anchor=(0.6, -0.15), columnspacing=1)
...
plt.savefig("../z_figs/SUssca2cutP8.pdf", format='pdf',bbox_extra_artists=(lgd,), bbox_inches='tight')
plt.savefig("../z_figs/SUssca2cutP8.png", format='png',bbox_extra_artists=(lgd,), bbox_inches='tight')
