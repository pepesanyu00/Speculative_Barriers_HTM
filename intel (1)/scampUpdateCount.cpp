...
#define PATH_RESULTS "./resultsUpdateCount/"
...
ITYPE updateItry=0, updateI=0, updateJtry=0, updateJ=0;
...
int main(int argc, char *argv[])
{
  try
  {
    ...
    statsFile.close();
    cout << "Updates/tries en I: " << updateI << "/" << updateItry << " y en J: " << updateJ << "/" << updateJtry << endl;
